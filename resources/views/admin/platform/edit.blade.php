    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.platform.update',$platform->id) }}" method="POST" enctype="multipart/form-data">
                    <div class="grid grid-cols-2 gap-6 p-6 text-gray-900 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2">
                        ...
                        <div>
                            ...
                            <x-text-input id="auto_login_url" name="auto_login_url" type="text" class="mt-1 block w-full"
                                :value="old('auto_login_url',$platform->auto_login_url)" />
                    ...
                    <div class="flex">
                        ...
                        <input id="photo" name="photo" type="file" class="mt-1 block w-full"
                            :value="old('photo',$platform->photo)" />
